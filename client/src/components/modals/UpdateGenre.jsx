...
import DeleteGenre from "./DeleteAlbum";
  const UpdateGenre = observer(({ show, onHide, artist }) => {
    ...
    const [formData, setFormData] = useState({
      ...
      <Modal.Footer>
        ...
        <Button className="but" variant="outline-danger"   onClick={() => {setConfirmDelete(true)}}> Delete</Button>
          <DeleteGenre key={artist.id} artist={artist} show={confirmDelete} onHide={() => setConfirmDelete(false)}/>
